				...
				<form action="addmissionadd.jsp">
					<ul class="field-list">
						...
						<li> 
							...
							<div class="form-input">
								<input type="text" name="addrno" placeholder="Aadhaar Number" required >
							</div>
						</li>
						<li>
  ...
  <option value="SC">SC</option>
   <option value="NT">NT</option>
							...
							<div class="form-input">
									...
									<input type="text" placeholder="Enter Fees" name="fees" required>
							...
							<div class="form-input">
									...
									<input type="text" placeholder="Enter Fees Paid" name="feespaid" required>  
