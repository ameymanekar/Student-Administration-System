...
<html>
    ...
    <body>
        <table cellspacing="5px" width="100%" >
            <th><td><form action="showname.jsp">
           <h2> Search : <input type="text" name="search"  value='<%=search%>'  placeholder="Search.." size="50%" required >
           </h2>
            </form></td></th>
                ...
                for(int i=0;i<vlist.size();i++)
            {
                ...
                <tr>
                   <td></td>
                    ...
                    <td><%=s.getContactno()%></td><td><%=s.getDOB()%></td>
                    <td><%=s.getJoindate()%></td><td><%=s.getcast()%></td>
