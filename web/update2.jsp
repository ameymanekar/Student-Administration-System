...
<body>
					...
					<ul class="field-list">
						...
						<li class="name">
							...
							<div class="form-input">
									...
									<input type="text"  pattern="[A-Z a-z]+" name="name" value="<%=resultSet.getString("name") %>" placeholder="Full Name" required>
						...
						<li> 
							...
							<div class="form-input">
								<input type="text" pattern="[1,2,3,4,5,6,7,8,9,0]{10}" name="contactno"value="<%=resultSet.getString("contactno") %>" placeholder="Phone Number" maxlength="10" required >
							</div>
						</li>
                                                <li> 
							<label class="form-label"> Aadhaar Number <span class="form-required"> * </span></label>
							<div class="form-input">
								<input type="text" pattern="[1,2,3,4,5,6,7,8,9,0]{12}" name="addrno"value="<%=resultSet.getString("addrno") %>" placeholder="Aadhaar Number" maxlength="12" required >
							</div>
						</li>
						<li>
  ...
  <option value="BBA III">BBA III</option>
                                                ...
                                                <li>
							<label class="form-label"> Category:Cast<span class="form-required"> * </span></label>
							<div class="form-input">
  ...
  <option value="SC">SC</option>
   <option value="NT">NT</option>
							...
							<div class="form-input">
									...
									<input type="text"  value="<%=resultSet.getString("fees") %>" placeholder="Enter Fees" name="fees" required>
							...
							<div class="form-input">
									...
									<input type="text"  value="<%=resultSet.getString("feespaid") %>" placeholder="Enter Fees Paid" name="feespaid" required>  
						...
						<li>
							...
							<div class="form-input">
									...
									<input type="date" placeholder=""value="<%=resultSet.getString("joindate") %>" name="joindate" style="width: 98%; height: 30px;"  required> 
